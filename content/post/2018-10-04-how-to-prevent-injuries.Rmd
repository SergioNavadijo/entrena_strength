---
title: The war on injuries
author: ''
date: '2018-10-04'
slug: how-to-prevent-injuries
categories: []
tags: []
description: ''
---
...
While there is some truth to those narratives, there are also things that you can do -and things that you can stop doing- to at least decrease the risk of getting injured.

Common sense is not very common, so let's start from the beginning: 
If you are recovering from an injury, don't come back too soon.  
Gymnasts will rush getting back to training while still injured because being young and patient are not synonyms.
This sense of urgency will bite you in the back harder than if you would just have waited longer to recover. 
...
A third thing that you want to consider to reduce injuries is strength training.
...
Also, in this studies, strength training almost halved overuse injuries. You read that right. Not only is strength training the only proven method that will profoundly reduce your acute injury risk, but it will mitigate chronic injuries to 50%. If that weren't enough, strength training would likely improve key performance indicators like your vertical jump and your postural control. If that doesn't convince you to start strength training, nothing will.
...
Another great benefit of lifting weights is increased bone density. If you don't want to be a fragile gymnast, you need a moderate amount of stress on your skeleton. Jumps are one part of the equation, weightlifting with perfect form is the other.

Doing too much of it could be a bad thing, but gymnastics without a base of strength is trouble guaranteed. Don't fear the weights: every athlete works hard in the gym, and there is no reason why gymnasts shouldn't.
